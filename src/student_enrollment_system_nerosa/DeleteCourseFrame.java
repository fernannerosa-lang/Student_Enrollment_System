...
public class DeleteCourseFrame extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DeleteCourseFrame.class.getName());

    /**
     * Creates new form DeleteCourseFrame
     */
    public DeleteCourseFrame(CoursesGUI GUI) {
        initComponents();
        this.GUI = GUI;
    }
    ...
    private void initComponents() {
        ...
        delStudentBtn.setText("Delete Course");
    ...
    try {
            dao.deleteCourse(Integer.parseInt(idStr));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DeleteCourseFrame().setVisible(true));
    }
